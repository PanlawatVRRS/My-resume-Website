...
export default function Projects() {
  ...
  return (
    <section id="projects" className="mx-auto max-w-5xl px-4 sm:px-6 py-12 sm:py-16">
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        ...
        {/* ปุ่มควบคุมการเลื่อน ซ้าย - ขวา (แสดงเฉพาะจอ md ขึ้นไป) */}
      ...
      {/* 
        - Mobile: แสดงเป็น Grid เรียงลงมาแนวยาวเต็มจอพอดี (ไม่ใช้สไลด์)
        - Desktop (md ขึ้นไป): ใช้ระบบ Slide พร้อมอนิเมชันผ่าน Tailwind และ Framer Motion
      */}
      <div className="w-full">
        {/* สำหรับมือถือ (แสดงเฉพาะจอมือถือ) */}
              ...
              <div key={project.id} className="w-full">
                <div className="w-full h-full">
                  <motion.div
                    ...
                    className="group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-white/20 dark:border-white/10 bg-white/10 dark:bg-white/5 backdrop-blur-xl p-5 sm:p-6 shadow-xl shadow-black/5 transition-all duration-500 hover:border-accent/50 hover:shadow-accent/10"
                  >
                    ...
                    <div className="relative z-10 flex-1">
                      ...
                      <h3 className="font-display text-lg sm:text-xl font-semibold tracking-tight text-ink transition-colors duration-300 group-hover:text-accent">
                        {project.name[lang] || project.name['en']}
                      </h3>

                      <p className="mt-2.5 sm:mt-3 font-body text-xs sm:text-sm leading-relaxed text-ink-soft">
        ...
        {/* สำหรับ Desktop (แสดงเฉพาะจอ md ขึ้นไป พร้อมระบบสไลด์) */}
          ...
          >
            {projects.map((project) => {
              ...
              return (
                <div 
                  key={project.id} 
                  className="box-border px-3 flex-shrink-0"
